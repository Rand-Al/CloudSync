 ...
 * @since 1.0.0
 * 
 * @global array $_POST HTTP POST data
 * @global array $_SERVER Server and environment information
 * @global array $_GET HTTP GET data
 */

// Define PHP filter constants if not already defined
